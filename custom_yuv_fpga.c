...
/*
 * A V4L2 driver for CSI2 sources with no control.Configured to receive
 * YUV data from a custom FPGA over the CSI2 interface in FULL HD 60fos.
 *.
 ...
 */
                  ...
                  struct v4l2_subdev_format *fmt)
 {
     ...
     fmt->format.code = REAL_MBUS_CODE;
 ...
 static int sensor_probe(struct platform_device *pdev)
 {
     ...
     sensor->fmt.code = REAL_MBUS_CODE;
